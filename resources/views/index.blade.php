...
<div class="mx-10 mt-32">
    ...
    <div class="lg:flex flex-none justify-evenly mt-10">
        <div class="flex flex-wrap justify-center lg:w-4/12 w-full bg-white ring-4 ring-yellow-100 p-6 items-center">
        ...
        <div class="flex flex-wrap justify-center lg:w-4/12 w-full lg:mt-0 mt-10 bg-white ring-4 ring-yellow-100 p-6 items-center">
            <div class="w-24 lg:w-3/12">
...
{{--footer--}}
<div class="w-full object-fit bg-no-repeat mt-44 relative">
